...
from .models import CustomerProfileInfo, AdvertiserProfileInfo, CityCorporationProfileInfo, PostAdvertiseTable
...
class post_from(forms.ModelForm):
    class Meta:
        ...
        fields = (
            'title', 'location', 'Spec_loc', 'width', 'height', 'price', 'short_desc', 'posted_billboards_pic')
        labels = {
            "title": "Title:",
            "location": "District:",
