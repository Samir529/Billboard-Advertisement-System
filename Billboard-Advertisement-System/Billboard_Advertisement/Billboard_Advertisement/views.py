...
from .forms import UserForm, customerProfilePicForm, advertiserProfilePicForm, cityCorporationProfilePicForm, \
    changePassForm, post_from

from .models import CustomerProfileInfo, AdvertiserProfileInfo, CityCorporationProfileInfo, CurrentPriceUpdate, \
    PostAdvertiseTable
...
def viewPost(request):
    ...
    context = {'allPosts': allPosts, 'filter': billboard_filter}
