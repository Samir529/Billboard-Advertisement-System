"""
Django settings for Billboard_Advertisement project.
...
SECRET_KEY = 'o8w46&h+x$*@g_^tp0x@z(r%8rvt+)hr5p(b$=p-66e%5lb1))'
...
LOGIN_URL = '/Billboard_Advertisement/user_login'   ##
LOGIN_REDIRECT_URL = '/'    ##
